      ...
      <div className="auth-page">
        <div className="auth-card">
          <div className="auth-logo">
            <img src="/logo.png" alt="ScorePorch" className="auth-logo-img" />
            <span className="auth-logo-text">ScorePorch</span>
          </div>
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <p className="auth-subtext">
          {mode === 'signin'
            ? 'Sign in to your personalized scoreboard'
            : 'Free forever for one team. Upgrade anytime.'}
        </p>
